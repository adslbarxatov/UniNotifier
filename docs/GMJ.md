...
того, такая «перегонка» позволила провести качественную фильтрацию наполнения. В процессе даже появился файл-шаблон
с порядковыми номерами всех «живых» записей, который временно использовался в приложении для ускорения работы.
...
доступных, что исключает повторы. Список сбрасывается, когда достигается конец диапазона.

В таком виде данный механизм исправно работает уже двух лет. Он потенциально может быть применён к любому контенту
